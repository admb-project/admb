...
extern df1_one_variable polevl (const df1_one_variable&, void *, int );
extern double p1evl ( double, void *, int );
extern df1_one_variable p1evl ( const df1_one_variable& , void *, int );
...
int operator < (const df1_one_variable& x,double n) { return value(x) < n; }
int operator > (const df1_one_variable& x,double n) { return value(x) > n; }
int operator >= (const df1_one_variable& x,double n) { return value(x) >= n; }
int operator == (const df1_one_variable& x,const df1_one_variable& n) { return value(x)==value(n); }
int operator == (const df1_one_variable& x,double n) { return value(x)==n; }
int operator == (double x,const df1_one_variable& n) { return x==value(n); }
int operator < (const df1_one_variable& x,const df1_one_variable& n) { return value(x)<value(n); }
int operator > (const df1_one_variable& x,const df1_one_variable& n) { return value(x)>value(n); }


df1_one_variable lgam(df1_one_variable& x)
{
df1_one_variable  p,q, u, w, z,p1;
int i;
...
df1_one_variable polevl( const df1_one_variable&  x, void * _coef, int N )
{
double * coef=(double *)(_coef);
df1_one_variable  ans;
int i;
double *p;
...
df1_one_variable p1evl(const df1_one_variable & x, void * _coef, int N )
{
double * coef= (double*)(_coef);
df1_one_variable ans;
double *p;
