...
df1_two_variable igam(const df1_two_variable & a,const df1_two_variable & x);
//  what should MAXLOG be?
  double MAXLOG=200;
  static double big = 4.503599627370496e15;
  static double biginv =  2.22044604925031308085e-16;
  static MACHEP=2.22045e-16;
/*							gamma.c
 *
 *	Gamma function
 *
...
extern df1_two_variable polevl (const df1_two_variable&, void *, int );
extern double p1evl ( double, void *, int );
extern df1_two_variable p1evl ( const df1_two_variable& , void *, int );
...
int operator < (const df1_two_variable& x,double n) { return value(x) < n; }
int operator > (const df1_two_variable& x,double n) { return value(x) > n; }
int operator >= (const df1_two_variable& x,double n) { return value(x) >= n; }
int operator == (const df1_two_variable& x,const df1_two_variable& n) { return value(x)==value(n); }
int operator == (const df1_two_variable& x,double n) { return value(x)==n; }
int operator == (double x,const df1_two_variable& n) { return x==value(n); }
int operator < (const df1_two_variable& x,const df1_two_variable& n) { return value(x)<value(n); }
int operator > (const df1_two_variable& x,const df1_two_variable& n) { return value(x)>value(n); }


df1_two_variable lgam(df1_two_variable& x)
{
df1_two_variable  p,q, u, w, z,p1;
int i;
...
df1_two_variable polevl( const df1_two_variable&  x, void * _coef, int N )
{
double * coef=(double *)(_coef);
...
df1_two_variable p1evl(const df1_two_variable & x, void * _coef, int N )
{
double * coef= (double*)(_coef);
df1_two_variable ans;
double *p;
...
main()
{
  ...
  for (double x=1;x<=10;x+=0.5)
  {
    ...
    *va.get_u_y()=-4.75;
    ...
    cout << value(vx) << " " << value(igam(va,vx)) << endl;
    //cout << value(vx) << " " << value(lgam(vx)) << " " << value(exp(lgam(vx))) << endl;
    //printf(" %lf %lf %lf \n",x,lgam(x),exp(lgam(x)));
  }
}
...
df1_two_variable igam(const df1_two_variable & a,const df1_two_variable & x);
  ...
  // static double biginv =  2.22044604925031308085e-16;
  // 
   df1_two_variable igamc(const df1_two_variable & _a, 
     const df1_two_variable & _x)
   {
     ADUNCONST(df1_two_variable,a)
     ADUNCONST(df1_two_variable,x)
   df1_two_variable ans, ax, c, yc, r, t, y, z;
   df1_two_variable pk, pkm1, pkm2, qk, qkm1, qkm2;
  ...
  //  */
  // 
   df1_two_variable igam(const df1_two_variable & _a, 
    const df1_two_variable & _x )
   {
      ADUNCONST(df1_two_variable,a)
      ADUNCONST(df1_two_variable,x)

   df1_two_variable ans, ax, c, r;
