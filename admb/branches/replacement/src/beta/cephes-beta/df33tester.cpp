...
df3_three_variable igam(const df3_three_variable & a,const df3_three_variable & x);
...
df3_three_variable igam(const df3_three_variable & a,const df3_three_variable & x);
 ...
 // 
 // 
  df3_three_variable incbcf(const df3_three_variable & _a, const df3_three_variable & _b, const df3_three_variable & _x );
  df3_three_variable pseries(const df3_three_variable & _a, const df3_three_variable & _b, const df3_three_variable & _x );
  df3_three_variable incbd(const df3_three_variable & _a, const df3_three_variable & _b, const df3_three_variable & _x );
...
df3_three_variable df3_get_values(double a,double b,double x)
{
   df3_three_variable va,vb,vx;
   va.initialize();
   vb.initialize();
