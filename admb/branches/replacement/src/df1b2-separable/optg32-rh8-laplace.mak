...
FLAGS1 = $(CFLAGS) -w ${OPTIONS} ${PVMOPTION} -DOPT_LIB  -fpermissive -DUSE_LAPLACE -c -I. -I../nh99 -I../linad99 -I../tools99 -I../beta/cephes-beta -Dlinux -D__GNUDOS__
...
FLAGS = $(CFLAGS) -fno-for-scope -Wall -Wno-non-virtual-dtor -Wno-comment -Wno-strict-aliasing -Wno-write-strings -Wno-unused-function -Wno-unknown-pragmas -Wno-sign-compare -Wno-missing-braces -Wno-cast-qual -Wno-uninitialized -Wno-reorder -Wno-deprecated -Wno-unused-label -Wno-unused-variable ${OPTIONS} ${PVMOPTION} -DOPT_LIB  -fpermissive -DUSE_LAPLACE -c -I. -I../nh99 -I../linad99 -I../tools99 -I../beta/cephes-beta -Dlinux -D__GNUDOS__
