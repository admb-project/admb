CC = gcc
LL = tlib
FLAGS1 = ${OPTIONS} ${PVMOPTION} -g -DSAFE_ALL -DUSE_LAPLACE -O3 -c -I. -I../nh99 -I../linad99 -I../tools99  \
  -D __GNUDOS__ 

FLAGS = ${OPTIONS} ${PVMOPTION} -DSAFE_ALL -DUSE_LAPLACE -O3 -c -I. -I../nh99 -I../linad99 -I../tools99 -Dlinux -D __GNUDOS__
