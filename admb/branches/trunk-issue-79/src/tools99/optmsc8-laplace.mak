...
LL = tlib
LIBPATH = msc8olp
FLAGS = /nologo /W4 /wd4512 /wd4511 /wd4100 /wd4244 /wd4068 /wd4996 /wd4127 /wd4706 ${OPTIONS} ${PVMOPTION} /GF /EHsc -DUSE_LAPLACE -DWIN32 /c -I. -I../df1b2-separable -I../nh99 -I../linad99 -D__MSVC32__=8  -DOPT_LIB /Ox
LIBNAME = adt32.lib 
LIBRARIAN = tlib
SRCDIR =  src
LIBDIR =  lib
