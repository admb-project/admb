...
Source: "..\..\utilities\MinGW-gcc4.4\*"; DestDir: "{app}\utilities\MinGW"; Excludes: ".svn,*\.svn"; Flags: recursesubdirs
Source: "..\..\utilities\set-utilities-path.bat"; DestDir: "{app}\utilities"
