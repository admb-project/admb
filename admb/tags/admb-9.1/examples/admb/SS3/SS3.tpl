...
//      if(s>Turn_off_phase) s=max(1,Turn_off_phase);
 ...
 END_CALCS
  ...
  init_ivector More_Std_Input(1,Do_More_Std*6)
 LOCAL_CALCS
 ...
 END_CALCS
  ...
  int Do_Growth_Std;
  int Growth_Std_Cnt;
  int Selex_Std_N;   //  dimension for the sdreport vector Selex_Std which also contains the Growth_Std
...
//  matrix WtFreq_begin(styr,endyr,1,nlength2);
 ...
 END_CALCS
  ...
  sdreport_vector Selex_Std(1,Selex_Std_N)
