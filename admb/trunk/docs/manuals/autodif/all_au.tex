...
\bigbreak
\listing{examples/simple/fcomp_s.cpp}
...
\bigbreak
\listing{examples/simple/simple.cpp}
...
\bigbreak
\listing{examples/hemholtz/hem_func.cpp}
...
\bigskip
\listing{examples/hemholtz/hemholtz.cpp}
...
\bigskip
\listing{examples/io_examp/io_examp.cpp}
...
\bigskip
\listing{examples/minimize/minimize.cpp}
...
\bigbreak
\listing{examples/minimize/userfun.cpp}
...
\bigskip
\listing{examples/robexamp/robust.cpp}
\bigbreak
{\openup 1.3truept
\listing{examples/robexamp/fcomp_r.cpp}
\bigbreak
\listing{examples/robexamp/newreg2.cpp}
}
\bigbreak
...
\bigskip
\listing{examples/newt/newt.cpp}
...
\goodbreak\bigbreak
\listing{examples/mixture/like.cpp}
...
\goodbreak\bigbreak
\listing{examples/mixture/reset.cpp}
...
\bigbreak
\listing{examples/mixture/xinit.cpp}
...
\bigbreak
\listing{examples/mixture/nvarcal.cpp}
...
named {\tt mixture.par}.
\bigbreak
\listing{examples/mixture/mixture.cpp}
...
\bigbreak
\listing{examples/mixture/fcomp_m.cpp}
...
to~$1$. 
\bigbreak
\listing{examples/mixture/normaliz.cpp}
\X{penalty function}
...
\bigbreak
\listing{examples/mixture/savepar.cpp}
\endchapter
