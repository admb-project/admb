...
LL = tlib
LIBPATH = msc6olp
FLAGS = ${PVMOPTION} -Ik:/temp/ATLAS/include -DUSE_LAPLACE -DWIN32 /c -I. -I../nh99 -I../tools99 -I../df1b2-separable -D__MSVC32__ /G6 -DOPT_LIB /Ox -Ih:/vc6/include
FLAGS1 = ${PVMOPTION} -I../nh99 -DWIN32 /c -I. -D__MSVC32__ /G6 -DOPT_LIB /Ox -I../tools99  -Ih:/vc6/include
LIBNAME = ado32.lib 
LIBRARIAN = tlib
DRIVECHANGE=
#DRIVECHANGE=g.bat
