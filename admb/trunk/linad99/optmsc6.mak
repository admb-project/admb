...
FLAGS =  ${OPTIONS} -DWIN32 /c -I. -I../nh99 -I../tools99 -D__MSVC32__ /G6 -DOPT_LIB /Ox -Ih:/vc6/include
FLAGS1 = ${OPTIONS} -I../nh99 -DWIN32 /c -I. -D__MSVC32__ /G6 -DOPT_LIB /Ox -I../tools99  -Ih:/vc6/include
LIBNAME = ado32.lib 
LIBRARIAN = tlib
DRIVECHANGE=
#DRIVECHANGE=g.bat
