...
SHELL=sh
LL = tlib
FLAGS =  ${OPTIONS} -w -DSAFE_ALL -D__GNUDOS__ -Dlinux -fpermissive -O3 -c -I. -I../nh99 -I../tools99 -D__SPDLL__ 
FLAGS1 = ${OPTIONS} -g -DSAFE_ALL -D__GNUDOS__ -Dlinux -fpermissive -O3 -c -I. -I../nh99 -I../tools99 -D__SPDLL__ 
LIBPATH =gcc32-rh8s
LIBNAME = libads.a
LIBDIR = lib
INCLDIR= include
