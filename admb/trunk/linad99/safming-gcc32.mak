...
FLAGS = ${OPTIONS} -Dlinux -fpermissive -x c++ -O3 -c -I../df1b2-separable -I. -I../nh99 -I../tools99 -D __GNUDOS__ -DSAFE_ALL

FLAGS1 = ${OPTIONS} -g -Dlinux -fpermissive -x c++ -O3 -c -I../df1b2-separable -I. -I../nh99 -I../tools99 -D __GNUDOS__ -D SAFE_ALL
