...
LL = tlib
LIBPATH = msc7s
FLAGS = ${OPTIONS}  -DWIN32 /c -I. -I../nh99 -I../tools99 -D__MSVC32__=7  -DSAFE_ALL -Ig:/vc7/include
FLAGS1 =  ${OPTIONS} -DWIN32 /c -I.-I../nh99  -D__MSVC32__=7 /G7 -DSAFE_ALL   -I../tools99  -Ig:/vc7/include
LIBNAME = ads32.lib 
LIBRARIAN = tlib
DRIVECHANGE=
#DRIVECHANGE=g.bat
