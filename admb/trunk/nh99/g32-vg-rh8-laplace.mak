...
LL = tlib
FLAGS1 = ${OPTIONS} -g -DUSE_LAPLACE -fpermissive -O -c -I. -I../df1b2 -I../linad99 -I../tools99 -D__SPDLL__ \
-D__GNUDOS__  -Dlinux
FLAGS = ${OPTIONS} -g -DUSE_LAPLACE -fpermissive -O -c -I. -I../df1b2 -I../linad99 -I../tools99 -D__SPDLL__ \
-D__GNUDOS__  -Dlinux
