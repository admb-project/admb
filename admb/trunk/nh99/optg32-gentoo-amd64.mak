...
CC = gcc
LL = tlib
FLAGS1 = ${OPTIONS} -m64 -fpermissive -O3 -c -I. -I../linad99 -I../tools99 -D__SPDLL__ \
-D__GNUDOS__ -DOPT_LIB -Dlinux
FLAGS = ${OPTIONS} -w -m64 -fpermissive -O3 -c -I. -I../linad99 -I../tools99 -I../df1b2-separable -D__SPDLL__ \
-D__GNUDOS__ -DOPT_LIB -Dlinux
