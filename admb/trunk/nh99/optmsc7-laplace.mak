...
LL = tlib
LIBPATH = msc7olp
STUBPATH = msc7olp-stub
STUBLIBNAME = df1b2stub.lib
FLAGS = ${OPTIONS} ${PVMOPTION} -DUSE_LAPLACE /EHsc -Ig:/vc7/include -DWIN32 /c /W3 /I. /I../linad99 /I../df1b2-separable /I../tools99 -D__MSVC32__=7 -DOPT_LIB /Ox 
LIBNAME = admod32.lib 
LIBRARIAN = tlib
