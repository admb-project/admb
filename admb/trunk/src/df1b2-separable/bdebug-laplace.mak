...
CC = bcc32
LL = tlib
FLAGS = ${OPTIONS} -I. -Ic:/bc5/include -I../hans-sparse -I../linad99 -I../nh99 -DWIN32 -I../tools99 -DSAFE_ALL -v -r- -Vd -Od -DUSE_LAPLACE -DUSE_ADPVM -DUP -5 -c 
...
$(LIBPATH)/$(LIBNAME) :  $(OBJ0) $(OBJSPLUS)
	...
	cd $(LIBPATH) ; del *.lib ; ls *.obj >> t.rsp
	cd ..
