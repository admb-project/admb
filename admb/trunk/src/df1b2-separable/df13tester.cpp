...
extern df1_three_variable polevl (const df1_three_variable&, void *, int );
extern double p1evl ( double, void *, int );
extern df1_three_variable p1evl ( const df1_three_variable& , void *, int );
...
static df1_three_variable gamma(const df1_three_variable & xx1)
{
  ...
  x=xx1;
   ...
   MYBIG=1.e+300;
df1_three_variable p, q, z;
df1_three_variable zero;
zero=0.0;
int i;
...
int operator < (const df1_three_variable& x, double n) { return value(x) < n; }
int operator > (const df1_three_variable& x,double n) { return value(x) > n; }
int operator >= (const df1_three_variable& x,double n) { return value(x) >= n; }
int operator == (const df1_three_variable& x,const df1_three_variable& n) { return value(x)==value(n); }
int operator == (const df1_three_variable& x,double n) { return value(x)==n; }
int operator == (double x,const df1_three_variable& n) { return x==value(n); }
int operator < (const df1_three_variable& x,const df1_three_variable& n) { return value(x)<value(n); }
int operator > (const df1_three_variable& x,const df1_three_variable& n) { return value(x)>value(n); }
...
dvariable incbet(const dvariable& _a,const dvariable& _b,
  const dvariable& _x)
{
  ADUNCONST(dvariable,a)
  ADUNCONST(dvariable,b)
...
static df1_three_variable igam(const df1_three_variable & a,const df1_three_variable & x);
  ...
  // 
   ...
   df1_three_variable pk, pkm1, pkm2, qk, qkm1, qkm2;
...
df1_three_variable incbet(const df1_three_variable & _aa, 
                          ...
                          const df1_three_variable & _xx )
 {
   ...
   df1_three_variable xx;
   aa=_aa;
   bb=_bb;
   xx=_xx;

 df1_three_variable a, b, t, x, xc, w, y;

 int flag;
 df1_three_variable one;
 df1_three_variable zero;
 one=1.0;
 zero=0.0;
...
static df1_three_variable df3_get_values(double a,double b,double x)
{
  ...
  //  cout << "enter a" << endl;
  //  cin >> x0;
  //  df1_three_variable tp;
  //  df1_three_variable tm;
  //  tp=2.0+h;
  //  tm=2.0-h;
  ...
  //    }
  //  }
  //  df1_three_variable z3=df3_get_values(x0,y0,z0);
  //  //df1_three_variable z3= x0*y0*z0;
  //  
  //  cout << endl;
  //  
