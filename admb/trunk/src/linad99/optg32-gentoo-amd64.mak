...
SHELL=sh
LL = tlib
FLAGS =   ${OPTIONS} -m64 -DOPT_LIB -D__GNUDOS__ -Dlinux -fpermissive -O3 -c -I. -I../nh99 -I../tools99 -I../df1b2-separable 
FLAGS1 = ${OPTIONS} -g -m64 -DOPT_LIB -D__GNUDOS__ -Dlinux -fpermissive -O3 -c -I. -I../nh99 -I../tools99  -I../df1b2-separable  
