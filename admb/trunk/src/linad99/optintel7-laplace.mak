...
LL = tlib
LIBPATH = intel7olp
FLAGS =  /MD -Qvc7.1 -DUSE_LAPLACE -DWIN32 /c -I. -I../nh99 -I../tools99 -D__MSVC32__ /G6 -DOPT_LIB /Ox -Ig:/vc7/include
FLAGS1 = /MD -DWIN32 /c -I. -D__MSVC32__ /G6 -DOPT_LIB /Ox -I../tools99  -Ig:/vc6/include
LIBNAME = ado32.lib 
LIBRARIAN = tlib
DRIVECHANGE=
#DRIVECHANGE=g.bat
