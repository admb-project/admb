...
LL = tlib
LIBPATH = msc7olp
FLAGS = ${OPTIONS} ${PVMOPTION} -Ik:/temp/ATLAS/include /EHsc -DUSE_LAPLACE -DWIN32 /c -I. -I../df1b2-separable -I../nh99 -I../tools99 -D__MSVC32__=7 /G6 -DOPT_LIB /Ox -Ig:/vc7/include
FLAGS1 = ${OPTIONS} ${PVMOPTION} -I../nh99 -DWIN32 /c /EHsc -I. -D__MSVC32__=7 /G6 -DOPT_LIB /Ox -I../df1b2-separable -I../tools99  -Ig:/vc7/include
LIBNAME = ado32.lib 
LIBRARIAN = tlib
DRIVECHANGE=
#DRIVECHANGE=g.bat
