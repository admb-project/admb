...
LL = tlib
LIBPATH = msc7o
FLAGS =   ${OPTIONS} -DWIN32 /c -I. -I../nh99 -I../tools99 -D__MSVC32__=7 /G7 -DOPT_LIB /Ox -Ig:/vc7/include
FLAGS1 =  ${OPTIONS} -DWIN32 /c -I. -D__MSVC32__=7 /G7 -DOPT_LIB /Ox -I../nh99 -I../tools99  -Ig:/vc7/include
LIBNAME = ado32.lib 
LIBRARIAN = tlib
DRIVECHANGE=
#DRIVECHANGE=g.bat
DISKDIR= g:/adms7.m32
DISKDIR1= g:/adms7.m32
SRCDIR =  src
LIBDIR =  lib
INCLUDEDIR = include 
