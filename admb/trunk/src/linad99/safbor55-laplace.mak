...
FLAGS = ${OPTIONS} -Vd -W- -O2 -6 -I../tools99 -I../nh99 -I../df1b2-separable -H=Hc -DUSE_LAPLACE -DDOS386 -DSAFE_ALL -DWIN32 -I. -c
...
$(LIBPATH)/$(LIBNAME) :  $(OBJ0) $(OBJ1) $(OBJ2) $(OBJ3) $(OBJSPLUS) $(OBJSPARSE)
