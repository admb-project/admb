...
SHELL=sh
LL = tlib
FLAGS = -DUSE_LAPLACE -fpermissive -O3 -c -I. -I../df1b2-separable -I../nh99 -I../tools99 -D__SPDLL__ \
-D__GNUDOS__ -DSAFE_ALL 
FLAGS1 = -DUSE_LAPLACE -g -fpermissive -O3 -c -I. -I../nh99 -I../tools99 -D__SPDLL__ \
-D__GNUDOS__ -DSAFE_ALL 
LIBPATH =gcc296-rh73slp
LIBNAME = libads.a
LIBDIR = lib
INCLDIR= include
