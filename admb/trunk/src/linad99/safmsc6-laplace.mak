...
LL = tlib
LIBPATH = msc6slp
FLAGS = ${PVMOPTION} -Ik:/temp/ATLAS/include -DUSE_LAPLACE -DWIN32 /c -I. -I../nh99 -I../tools99 -I../df1b2-separable -D__MSVC32__ -DSAFE_ALL /Ox -Ih:/vc6/include 
FLAGS1 = ${PVMOPTION} -DUSE_LAPLACE -I../nh99 -DWIN32 /c -I. -D__MSVC32__ -I../tools99 -DSAFE_ALL /O1 -Ih:/vc6/include 
LIBNAME = ads32.lib 
LIBRARIAN = tlib
DRIVECHANGE=
#DRIVECHANGE=g.bat
