...
CC = gcc
LL = tlib
FLAGS1 = -DUSE_LAPLACE -fpermissive -g -O3 -c -I. -I../linad99 -I../tools99 -D__SPDLL__ \
-D__GNUDOS__ -DOPT_LIB -Dlinux
FLAGS = -DUSE_LAPLACE -fpermissive -O3 -c -I. -I../df1b2-separable -I../linad99 -I../tools99 -D__SPDLL__ \
-D__GNUDOS__ -DOPT_LIB -Dlinux
