...
@echo on
cl -c -Zi /EHsc /DUSE_LAPLACE /DWIN32 %opt% /Ox /D__MSVC32__=8 /I. /I"%MSSDK%\include" /I"%ADMB32_HOME%\include" /I"%ADMB32_HOME%\include\CL" %1.cpp
@echo off
...
:HELP
echo Usage: adcomp32 [-d] [-r] [-s] model
echo.
