...
@echo on
cl  %1.obj %df1b2lib% %adlib% adt32.lib admod32.lib stats.lib priors.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /link /LIBPATH:"%ADMB32_HOME%/lib" /LIBPATH:"%MSSDK%/lib"
@echo off
