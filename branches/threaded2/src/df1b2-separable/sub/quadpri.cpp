/*
 * $Id: quadpri.cpp 944 2011-01-12 22:48:46Z johnoel $
 *
 ...
 */
  ...
  { 
    ...
    if (SCM==0)
    {
      ...
      // for now I think *pMinv ocntains the matrix -- not its inverse
 ...
 */
 ...
 { 
   ...
   {
   case 0:
     *objective_function_value::pobjfun+=0.5*(*pu)
       *(old_solve(_M,*pu,lndet,sgn));
 ...
 */
 ...
 { 
   ...
   case 0:
     {
       dvector v=old_solve(_M,value(*pu),lndet,sgn);
       double vv=0.5*value(*pu) * v;
       *objective_function_value::pobjfun+=vv;
       int fun_flag=0;
       if (fun_flag==0)
