...
*/
#define TRACE(object) cout << "line " << __LINE__ << ", file " << __FILE__ << ", " << #object " = " << setprecision(5) << object << endl;
...
*/
#define TTRACE(o1,o2) cout << "line " << __LINE__ << ", file " << __FILE__ << ", " << #o1 " = " << setprecision(5) << o1<< ", " << #o2 " = " << setprecision(5) << o2 << endl;
