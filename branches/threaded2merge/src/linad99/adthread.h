...
class adpthread_manager
{
  ...
  ppthreadfun ppf;
public:
  static int is_slave(void) { return slave_number ? 1 : 0; }
  static int is_master(void) { return !is_slave(); }
...
public:
  ...
  //void create_all(void* (*f)(void*), void* ptr);
  //void create_all(void* (*f)(void*), new_thread_data* ptr);
  //void create_all(void* (*f)(void*), thread_data* ptr);
