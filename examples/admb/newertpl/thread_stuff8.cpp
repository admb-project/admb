...
void adjoint_send_dvar5_array_to_slave(void)
{
  ...
  ptr->adjoint_send_dvar5_array_to_slave();
}

void adpthread_manager::adjoint_send_dvar5_array_to_slave(void)
{
...
void adpthread_manager::send_dvar5_array_to_slave(const dvar5_array &x,int sno)
{
  ...
  gradient_structure::GRAD_STACK1->
    set_gradient_stack(::adjoint_send_dvar5_array_to_slave);
}
...
void adjoint_get_dvar5_array_from_master(void)
{
  ...
  adpthread_manager * ptr=(adpthread_manager*)(restore_pointer_value());
  ptr->adjoint_get_dvar5_array_from_master();
}

void adpthread_manager::adjoint_get_dvar5_array_from_master(void)
{
...
dvar5_array adpthread_manager::get_dvar5_array_from_master(int sno)
{
 ...
 // &***********************************************************
  ...
  gradient_structure::GRAD_STACK1->
            set_gradient_stack(::adjoint_get_dvar5_array_from_master);
  return M;
}
