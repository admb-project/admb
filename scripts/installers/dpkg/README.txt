...
1. Download ADMB debian package
       ...
       For Ubuntu 14LTS (64Bit), download [admb-11.3-ubuntu14-64bit_11.2.deb](https://github.com/admb-project/admb/releases/download/admb-11.3/admb-11.3-ubuntu14-64bit_11.3.deb).

2. Install ADMB using Debian package manager (dpkg) as super-user.

        $ sudo dpkg -i admb-11.3-ubuntu14-64bit_11.3.deb
