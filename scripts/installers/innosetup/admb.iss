#define ADMB_VERSION "ADMB-13.2"
#define ADMB_VERSION2 "admb-13.2"
...
[Files]
Source: "..\..\..\build\admb-13.2\*"; DestDir: "{app}"; Flags: recursesubdirs
...
Source: "C:\rtools42\mingw64\*"; DestDir: "{app}\utilities\mingw64"; Flags: recursesubdirs
