...
1. Download ADMB installer
       ...
       For 64Bit, download [admb-11.3-ADMBTerminal-macos10-xcode6-64bit](https://github.com/admb-project/admb/releases/download/admb-11.3/admb-11.3-ADMBTerminal-macos10-xcode6-64bit.dmg).


       For 32Bit, download [admb-11.3-ADMBTerminal-macos10-xcode6-32bit](https://github.com/admb-project/admb/releases/download/admb-11.3/admb-11.3-ADMBTerminal-macos10-xcode6-32bit.dmg).  
...
5. Run the simple example.
    ...
    Read [manuals](https://github.com/admb-project/admb/releases/tag/admb-11.3/) for more information.
