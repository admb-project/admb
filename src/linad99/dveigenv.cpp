...
#else
  void tri_dag(BOR_CONST dvar_matrix& m,BOR_CONST dvar_vector& d,BOR_CONST dvar_vector& e);
#endif
#ifdef EIGEN_VECTORS
  void get_eigenv(_CONST dvar_vector& d,_CONST dvar_vector& e,BOR_CONST dvar_matrix& z);
#else
...
#endif
{
  ...
  if (m.rowsize() != m.colsize())
  {
    cerr << "Error -- non square matrix passed to void tridag(_CONST dvar_matrix& m)\n";
    ad_exit(1);
  }
...
#else
  void get_eigen(_CONST dvar_vector& _d,_CONST dvar_vector& _e,BOR_CONST dvar_matrix& _z)
#endif
{
