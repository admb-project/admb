...
// #endif
	 ...
	 // draw slice variable with sample.u(theta=theta.cur, r=r.cur)
	 
	 // Replace this for loop with the while(s==1) loop that calls buildtree. 
	 ...
	 // techinically don't need this anymore since NUTS draws
	 // uniformly, but we should save it for diagnostics. This also
	 // will correspond to testing for divergence.
	 ...
	 // This calculates the probability of the momenta, corresponding to a iid standard normal (sum squared)
         // if (robust_hybrid_flag)
         // {
         //   double choice=randu(rng);
         //   if (choice<0.05)
	 ...
	 // This testing phase gets replaced with the uniform testing code from NUTS
         if (rr<pp)
         {
           iaccept++;
           yold=y;
