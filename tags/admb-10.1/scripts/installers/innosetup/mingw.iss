...
OutputDir=..\..\..
OutputBaseFilename=admb-10.1-mingw-gcc4.5.2-32bit
...
[Files]
Source: "..\..\..\build\admb-10.1-mingw-gcc4.5.2-32bit\admb-10.1-mingw-gcc4.5.2-32bit\*"; DestDir: "{app}"; Excludes: ".svn,*\.svn"; Flags: recursesubdirs
