...
class test_df1_one_matrix: public ::testing::Test {};

/*
TEST_F(test_df1_one_matrix, default_constructor)
{
  df1_one_matrix x;
...
*/
TEST_F(test_df1_one_matrix, size_constructor)
{
  df1_one_matrix x(1, 5, 1, 2);
...
TEST_F(test_df1_one_matrix, copy)
{
  df1_one_matrix x(1, 5, 1, 2);
  df1_one_matrix y(x);
