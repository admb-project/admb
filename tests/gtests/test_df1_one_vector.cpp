...
class test_df1_one_vector: public ::testing::Test {};

TEST_F(test_df1_one_vector, default_constructor)
{
  df1_one_vector x;
...
TEST_F(test_df1_one_vector, size_constructor)
{
  df1_one_vector x(1, 5);
...
TEST_F(test_df1_one_vector, copy)
{
  df1_one_vector x(1, 5);
  df1_one_vector y(x);
