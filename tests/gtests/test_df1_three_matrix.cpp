...
class test_df1_three_matrix: public ::testing::Test {};

/*
TEST_F(test_df1_three_matrix, default_constructor)
{
  df1_three_matrix x;
...
*/
TEST_F(test_df1_three_matrix, size_constructor)
{
  df1_three_matrix x(1, 5, 1, 2);
...
TEST_F(test_df1_three_matrix, copy)
{
  df1_three_matrix x(1, 5, 1, 2);
  df1_three_matrix y(x);
