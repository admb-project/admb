...
class test_df1_three_vector: public ::testing::Test {};

TEST_F(test_df1_three_vector, default_constructor)
{
  df1_three_vector x;
...
TEST_F(test_df1_three_vector, size_constructor)
{
  df1_three_vector x(1, 5);
...
TEST_F(test_df1_three_vector, copy)
{
  df1_three_vector x(1, 5);
  df1_three_vector y(x);
