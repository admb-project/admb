...
class test_df1_two_matrix: public ::testing::Test {};

/*
TEST_F(test_df1_two_matrix, default_constructor)
{
  df1_two_matrix x;
...
*/
TEST_F(test_df1_two_matrix, size_constructor)
{
  df1_two_matrix x(1, 5, 1, 2);
...
TEST_F(test_df1_two_matrix, copy)
{
  df1_two_matrix x(1, 5, 1, 2);
  df1_two_matrix y(x);
