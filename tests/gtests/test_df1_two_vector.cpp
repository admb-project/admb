...
class test_df1_two_vector: public ::testing::Test {};

TEST_F(test_df1_two_vector, default_constructor)
{
  df1_two_vector x;
...
TEST_F(test_df1_two_vector, size_constructor)
{
  df1_two_vector x(1, 5);
...
TEST_F(test_df1_two_vector, copy)
{
  df1_two_vector x(1, 5);
  df1_two_vector y(x);
