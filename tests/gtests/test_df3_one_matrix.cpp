...
class test_df3_one_matrix: public ::testing::Test {};

/*
TEST_F(test_df3_one_matrix, default_constructor)
{
  df3_one_matrix x;
...
*/
TEST_F(test_df3_one_matrix, size_constructor)
{
  df3_one_matrix x(1, 5, 1, 2);
...
TEST_F(test_df3_one_matrix, copy)
{
  df3_one_matrix x(1, 5, 1, 2);
  df3_one_matrix y(x);
