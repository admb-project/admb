...
class test_df3_three_matrix: public ::testing::Test {};

/*
TEST_F(test_df3_three_matrix, default_constructor)
{
  df3_three_matrix x;
...
*/
TEST_F(test_df3_three_matrix, size_constructor)
{
  df3_three_matrix x(1, 5, 1, 2);
...
TEST_F(test_df3_three_matrix, copy)
{
  df3_three_matrix x(1, 5, 1, 2);
  df3_three_matrix y(x);
