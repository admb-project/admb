...
PROCEDURE_SECTION
  ...
  global_gs1 = new gradient_structure(10000, a.indexmin());
  global_gs2 = new gradient_structure(10000, a.indexmin() + 1);
  global_gs3 = new gradient_structure(10000, a.indexmin() + 2);
  global_gs4 = new gradient_structure(10000, a.indexmin() + 3);
