...
#include "compute-gradients-v3.h"
...
*/
  {
    auto f = compute_gradients(func, tau, nu, sigma, beta, a(1), nsteps);
    auto t = f.get();
  ...
  {
    auto f1 = compute_gradients(func, tau, nu, sigma, beta, a(i), nsteps);
    auto f2 = compute_gradients(func, tau, nu, sigma, beta, a(i + 1), nsteps);
