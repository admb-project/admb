[Setup]
OutputBaseFilename=admb-ide-101-win32
AppName=ADMB-IDE
AppVerName=ADMB-IDE 10.1 win32
...
Name: gcc;   Description: "GCC C++ compiler [c:/gnu/gcc452-win32]";     Types: full
...
Name: admbhome;  Description: "Define ADMB_HOME as c:/admb/admb101-gcc452-win32, so ADMB scripts work";           GroupDescription: "Registry:"
...
Source: "c:\gnu\gcc452-win32\*";        DestDir: "c:\gnu\gcc452-win32";  Components: gcc;   Flags: recursesubdirs
...
Root: HKCU; Subkey: "Environment"; ValueType: string; ValueName: "PATH";      ValueData: "c:/ADMB/admb101-gcc452-win32/bin;c:/gnu/GCC452-WIN32/bin;c:/gnu/GDB/bin;c:/gnu/EMACS/bin"; Tasks: path;     Flags: uninsdeletevalue
Root: HKCU; Subkey: "Environment"; ValueType: string; ValueName: "HOME";      ValueData: "c:/~";                                                                                     Tasks: home;     Flags: uninsdeletevalue
Root: HKCU; Subkey: "Environment"; ValueType: string; ValueName: "ADMB_HOME"; ValueData: "c:/ADMB/admb101-gcc452-win32";                                                             Tasks: admbhome; Flags: uninsdeletevalue
; File associations
