...
OutputDir=..\..\..
OutputBaseFilename=admb-trunk-mingw-gcc4.5.0-32bit
...
[Files]
Source: "..\..\..\build\admb-trunk-mingw-gcc4.5.0-32bit\admb-trunk-mingw-gcc4.5.0-32bit\*"; DestDir: "{app}"; Excludes: ".svn,*\.svn"; Flags: recursesubdirs
