...
OutputDir=..\..\..
OutputBaseFilename=admb-mingw-gcc4.5.0-32bit
...
[Files]
Source: "..\..\..\build\admb-mingw-gcc4.5.0-32bit\admb-mingw-gcc4.5.0-32bit\*"; DestDir: "{app}"; Excludes: ".svn,*\.svn"; Flags: recursesubdirs
